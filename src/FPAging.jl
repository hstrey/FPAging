...
using Distributions
using Random, RuntimeGeneratedFunctions
RuntimeGeneratedFunctions.init(@__MODULE__)

function fpprob(; kwargs...)
...
const FPprob = fpprob(; eval_expression=false, eval_module=@__MODULE__)

FPDist(η0,η1,ϵ,β,a,k,y0,σ,t0,t1,y_range) = FPDist(η0,η1,ϵ,β,a,k,y0,σ,t0,t1,y_range,FPsolve(η0,η1,ϵ,β,a,k,y0,σ,t0,t1,y_range,FPprob))
